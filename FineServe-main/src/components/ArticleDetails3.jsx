// src/components/AuditCallout.jsx
      ...
      <div className="container mx-auto max-w-4xl text-center">
        ...
        <button 
          ...
          style={{
            ...
            background: 'linear-gradient(90deg, #639BFF 0%, #3B7CFF 100%)',
            boxShadow: '0 8px 25px rgba(59, 124, 255, 0.4)',
          }}
        >
        ...
        <div className="mt-6 text-sm text-[#5A6775]">
          Have questions? <a href="#" className="font-bold text-[#1D2D3E] underline decoration-2 decoration-transparent hover:decoration-[#1D2D3E] transition-all duration-150">Let's Talk</a>
        </div>
      </div>
    </section>
  );
