    ...
    <div className="rounded-3xl p-8 relative overflow-hidden" style={{
      ...
      <div className="flex justify-center mb-6 relative">
        <div className="w-16 h-16 bg-blue-100 rounded-2xl flex items-center justify-center relative">
          {/* Connecting lines - Copied from the first card's style */}
          ...
          {/* Corner dots - Copied from the first card's style */}
          ...
          {/* The unique icon for each card (Unchanged) */}
          {icon}
        </div>
      </div>
...
// Data for each of the three cards (UPDATED FROM IMAGE)
const cardData = [
  {
    icon: ( // Icon SVG is unchanged
    ...
    title: '$35M+', // Changed
    description: 'Recovered for businesses to date' // Changed
  },
  {
    icon: ( // Icon SVG is unchanged
      <svg className="w-8 h-8 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    title: '60+ Years', // Changed
    description: 'Combined industry experience' // Changed
  },
  {
    icon: ( // Icon SVG is unchanged
      <svg className="w-8 h-8 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    title: 'Clients Nationwide', // Changed
    description: 'With global expansion underway' // Changed
  }
];

export default function ShipingLogistics4() {
  return (
    <div className="bg-[#F7FCFC] py-20 px-6 relative overflow-hidden">
      {/* Subtle grid background with gradient mask (Unchanged) */}
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        {/* Header (Text updated from image) */}
        <div className="text-center mb-16">
          ...
          <h2 className="text-5xl font-bold text-gray-900 mb-4">
            The Proof Is in Our Results {/* Changed */}
          </h2>
          <p className="text-gray-600 text-lg">
            {/* Changed - This text is from below the cards in the image */}
            Our results speak for themselves. One connection can change everything — and for our clients, it often means uncovering 6-7 figures in untapped profit. At FinServe360, we don’t just optimize costs — we set the standard for how businesses grow smarter.
          </p>
        </div>

        {/* Cards Grid - Now mapping the data to the reusable StatCard component (Unchanged) */}
