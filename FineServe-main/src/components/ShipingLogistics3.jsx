...
export default function ShipingLogistics3() {
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          <div className="space-y-24">
            ...
            <div className="relative flex items-center justify-between">
              ...
              >
                <h3 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-2">
                  Audit Your Shipping Spend
                </h3>
                <p className="text-gray-600">Identify hidden inefficiencies.</p>
              </div>
            ...
            <div className="relative flex items-center justify-between">
              ...
              >
                ...
                <p className="text-gray-600">
                  Integrate direct-to-carrier contracts.
                </p>
              </div>
            </div>
            ...
            <div className="relative flex items-center justify-between">
              ...
              >
                <h3 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-2">
                  Track & Save Continuously
                </h3>
                <p className="text-gray-600">
                  Ongoing optimization backed by live data.
                </p>
              </div>
