        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-white space-y-6">
            ...
            <h1 className="text-5xl lg:text-6xl font-bold leading-tight">
              <span className="italic font-light"> Recover Hidden</span> Payroll <br /> Credits -
              <span className="italic font-light">with</span>

              <span className=""> Zero <br /> Out-of-Pocket Cost</span>
            </h1>

            {/* Description */}
            <p className="text-lg text-white/90 leading-relaxed max-w-xl">
              Save $650–$850 per W2 employee per year, only program backed by an A+ rated carrier and filed independently by the Department of Insurance. We identify eligible employees to recover overage on payroll taxes securely using your existing payroll provider.
            </p>
