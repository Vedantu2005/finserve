...
const cardData = [
  {
    ...
    title: '15-45% Average<br />Savings',
    description: 'Proven carrier relationships that deliver.'
  },
  {
    icon: (
      <svg className="w-8 h-8 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Optimized routes and shipment consolidation.'
  },
  {
    icon: (
      <svg className="w-8 h-8 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Domestic, LTL/FTL, and international freight.'
  }
];
