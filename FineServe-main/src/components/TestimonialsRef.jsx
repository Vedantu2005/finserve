...
const TestimonialsRef = () => {
  ...
  return (
    <div className="bg-white py-12 sm:py-24 font-inter">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
          ...
          <div className="mb-10 lg:mb-0">
            {/* Tag */}
            <span className="text-xs sm:text-sm font-semibold text-blue-700 border border-blue-200 bg-blue-50 px-4 py-1.5 rounded-full inline-block tracking-wider">
                    ...
                    onError={(e) => {
                      ...
                      e.target.src =
                        ...
                        activeTestimonial.name
                          .split(" ")
                          .map((n) => n[0])
                          .join(""); // Placeholder with initials
                    }}
                  />
                  <div>
...
export default TestimonialsRef;
