...
const TruckIcon = ({ size, color, className }) => (
  <svg width="72" height="60" viewBox="0 0 72 60" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} style={{ width: size.width, height: size.height, color: color, transform: 'rotate(0deg)', opacity: 1 }}>
...
const HandCoinsIcon = ({ size, color, className }) => (
  <svg width="69" height="60" viewBox="0 0 69 60" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} style={{ width: size.width, height: size.height, color: color, transform: 'rotate(0deg)', opacity: 1 }}>
...
const CreditCardIcon = ({ size, color, className }) => (
  <svg width="66" height="59" viewBox="0 0 66 59" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} style={{ width: size.width, height: size.height, color: color, transform: 'rotate(0deg)', opacity: 1 }}>
...
const WalletIcon = ({ size, color, className }) => (
  <svg width="62" height="59" viewBox="0 0 62 59" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} style={{ width: size.width, height: size.height, color: color, transform: 'rotate(0deg)', opacity: 1 }}>
...
// ✅ NEW Funding Icon (Growth Chart with Arrow)
const FundingIcon = ({ size, color, className }) => (
  <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} style={{ width: size.width, height: size.height, color: color }}>
    <g filter="url(#filter0_d_funding)">
      ...
      <path opacity="0.2" d="M12 44V26C12 24.8954 12.8954 24 14 24H20C21.1046 24 22 24.8954 22 26V44H12ZM26 44V18C26 16.8954 26.8954 16 28 16H34C35.1046 16 36 16.8954 36 18V44H26ZM40 44V12C40 10.8954 40.8954 10 42 10H48C49.1046 10 50 10.8954 50 12V44H40Z" fill={color} />
      {/* Main Foreground Layer */}
      <path d="M50 44H12V46H50V44ZM54.7071 11.2929C54.3166 10.9024 53.6834 10.9024 53.2929 11.2929L39 25.5858L29.7071 16.2929C29.3166 15.9024 28.6834 15.9024 28.2929 16.2929L10.2929 34.2929C9.90237 34.6834 9.90237 35.3166 10.2929 35.7071C10.6834 36.0976 11.3166 36.0976 11.7071 35.7071L29 18.4142L38.2929 27.7071C38.6834 28.0976 39.3166 28.0976 39.7071 27.7071L54 13.4142V18C54 18.5523 54.4477 19 55 19C55.5523 19 56 18.5523 56 18V11C56 10.4477 55.5523 10 55 10H48C47.4477 10 47 10.4477 47 11C47 11.5523 47.4477 12 48 12H53.5858L54.7071 11.2929Z" fill={color} />
    </g>
    <defs>
...
// --- 2. Update the services array with new components ---
const services = [
  {
    icon: <TruckIcon />,
    title: "Shipping & Logistics",
    description:
      "From small parcels to LTL/FTL and international freight, our direct-to-carrier solutions maximize cost efficiency — all in one platform.",
  ...
  {
    // Updated with the new SVG (CreditCardIcon)
    icon: <CreditCardIcon />,
  ...
  },
  {
    ...
    description:
      "Fast, flexible access to working capital, expansion funding, and revenue-based financing.",
    link: "/funding",
  },
];


// --- 3. The main App component (largely unchanged structure) ---
const App = () => {
  const gradientClass =
    "bg-gradient-to-b from-[#3776BE] via-[#2A65B5] to-[#E9F3FA]";
  const blueText = "text-[#104D9D]";
  ...
  return (
    <>
      ...
      <section
        id="about-section"
        className="bg-gradient-to-b from-[#3776BE] to-[#F7FCFC] flex flex-col items-center px-4 sm:px-6 md:px-20 py-12 md:py-16 text-center md:text-left">
        <br /><br /><br /><br />
        <div className="w-full max-w-7xl flex flex-col md:flex-row items-center md:items-start gap-10">
          ...
          <div className="flex-1">
            ...
            <p className="text-white text-base sm:text-lg leading-relaxed max-w-xl mb-8 mx-auto md:mx-0">
              We specialize in optimizing your shipping, merchant processing,
              payroll tax savings, and consumer financing — helping you uncover
              hidden profits and strengthen your bottom line.
            </p>

            <a href="https://calendly.com/colin-finserve360/profit-recovery-audit">
              <button
                className="text-white font-medium px-5 sm:px-6 py-2.5 sm:py-3 rounded-[16px] shadow-lg text-sm sm:text-base"
                style={{
                  background:
          ...
          <div className="flex-1 flex justify-center md:justify-end">
            <img
              ...
              alt="Team"
              className="rounded-xl shadow-lg w-full md:w-[500px] lg:w-[600px] h-56 sm:h-64 md:h-[384px] object-cover"
              style={{
                borderRadius: "16px",
                opacity: "1",
              }}
      ...
      <section
        id="what-we-do"
        className="bg-#F7FCFC flex flex-col items-center px-4 sm:px-6 md:px-20 py-12 md:py-16 text-center md:text-left"
        ...
        <div className="max-w-7xl mx-auto w-full">
          ...
          {/* --- Services Grid --- */}
          {/* Changed grid-cols-4 to Flex-wrap centered layout for 5 cards */}
            ...
            {services.map((service, index) => (
              <div
                ...
                className="bg-white/80 backdrop-blur-md flex flex-col items-start text-left
                  shadow-xl shadow-blue-300/30 border-4 border-white transition duration-300
                  transform hover:scale-[1.03] hover:shadow-blue-500/50 cursor-pointer 
                  w-full sm:w-[calc(50%-12px)] lg:w-[calc(30%-16px)]" // Adjusted width for Flex layout
                style={{
                  borderRadius: "32px",
                  minHeight: "280px", // Reduced height on mobile
                  padding: "24px",
                }}>
                {/* Icon Wrapper */}
                <div className="mb-4">
                  {/* Pass standard size and color to all custom SVG components */}
                ...
                {/* Title */}
                <h3
                  className={`text-xl sm:text-2xl font-bold mb-2 ${blueText}`}>
                  {service.title}
                </h3>

                {/* Description */}
                <p className="text-gray-900 text-sm sm:text-lg mb-4 sm:mb-6 flex-grow">
                  {service.description}
                </p>
